...
function runBaseTests() {
  px_clipboard_1 = document.getElementById('px_clipboard_1');

  suite('Base Automation Tests for px-clipboard', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-clipboard fixture is created', function() {
      assert.isTrue(document.getElementById('px_clipboard_1') !== null);
    });
